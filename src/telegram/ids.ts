/**
 * Pure facts about Telegram identifiers this transport needs at its boundary.
 * Single-sourced here so the renderer and the mirror lookups cannot drift on
 * what a message citation is.
 */
 ...
 *
 * Only supergroups and channels do. Telegram gives their ids a `-100` prefix
 * over the internal id used in links, so `-1001234567890` links as
